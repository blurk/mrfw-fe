...
export function MangaInfoCard({
  ...
  return (
    <Card withBorder p="md" pt={0} className={classes.card}>
      ...
      <Card.Section className={classes.section} mt="md" pl="calc(10% + 150px)" sx={{ minHeight: 120 }}>
      ...
      <Card.Section className={classes.section}>
        <Text mt="md" color="dimmed">
          <strong>Thể loại:</strong> <Box sx={{ display: 'inline-flex', gap: 4 }}>{genresDisplay}</Box>
        </Text>
