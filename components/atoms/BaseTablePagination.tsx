import { ActionIcon, Group, Input, NumberInput, Select, Text } from '@mantine/core';
  ...
  return (
    <Group spacing={2} mt="md">
      ...
      <Group spacing={4}>
        <Text>Trang</Text>
        <Text weight={600}>
          {table.getState().pagination.pageIndex + 1} của {clamp(table.getPageCount(), 0, Number.MAX_SAFE_INTEGER)}
        </Text>
      </Group>
